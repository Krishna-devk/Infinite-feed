...
# --- SUPABASE CONFIG ---
SUPABASE_URL = "https://gszfxumifxdnahwczvbg.supabase.co"
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdzemZ4dW1pZnhkbmFod2N6dmJnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzgwNDI0MTQsImV4cCI6MjA5MzYxODQxNH0.ghSCmGhooxMN2WYmbxqKWa59r_ibxwR93aoogwSMElU"
BUCKET_NAME = "media"
...
def process_and_upload():
    ...
    for filename in os.listdir(INPUT_DIR):
        ...
        with Image.open(filepath) as img:
            ...
            raw_ext = img.format.lower()
            raw_path = f"{base_name}_raw.{raw_ext}"
            ...
            # Note: We pass the correct content-type for the raw file based on its extension
            upload_to_storage(raw_path, raw_bytes.getvalue(), f"image/{raw_ext}")
